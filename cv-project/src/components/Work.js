...
class Work extends Component {
  ...
  render() {
    const { company, title, resp, wDates, handleInput, handleSubmit } =
      this.props;
    return (
      <div>
        <div className="workHeaderContainer">
          ...
          <button
            className={this.state.saved ? "workEditButton" : "hide"}
            type="submit"
        ...
        <div
          className={this.state.saved ? "removeBackground" : "workContainer"}
        >
          <form className="workForm" onSubmit={(event) => handleSubmit(event)}>
            ...
            <div className="titleContainer">
              <label htmlFor="title" className={this.state.saved ? "hide" : ""}>
                Title:
              </label>
              <Title
                title={title}
            ...
            <div className="respContainer">
              <label htmlFor="resp" className={this.state.saved ? "hide" : ""}>
                Responsibilities:{" "}
              </label>
              <Resp
                resp={resp}
            ...
            <button
              className={this.state.saved ? "hide" : "workSaveButton"}
              type="submit"
              onClick={(event) => this.handleSave(event)}
            >
              Save
